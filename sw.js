importScripts("./version.js?v=26");

const cacheName = `medicinlogg-v${globalThis.MEDICINKOLL_VERSION}`;
const filesToCache = ["./", "./index.html", "./manifest.webmanifest", "./icon.svg", "./version.js?v=26", "./config.js?v=26", "./cloud-sync.js?v=26", "./push-notifications.js?v=26", "./privacy/", "./oauth/consent/", "./oauth/consent/consent.js?v=20"];
