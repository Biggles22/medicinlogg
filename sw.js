importScripts("./version.js?v=32");

const cacheName = `medicinlogg-v${globalThis.MEDICINKOLL_VERSION}`;
const filesToCache = ["./", "./index.html", "./manifest.webmanifest", "./icon.svg", "./version.js?v=32", "./config.js?v=32", "./cloud-sync.js?v=32", "./push-notifications.js?v=32", "./privacy/", "./oauth/consent/", "./oauth/consent/consent.js?v=20"];
