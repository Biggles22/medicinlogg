importScripts("./version.js?v=33");

const cacheName = `medicinlogg-v${globalThis.MEDICINKOLL_VERSION}`;
const filesToCache = ["./", "./index.html", "./manifest.webmanifest", "./icon.svg", "./version.js?v=33", "./config.js?v=33", "./cloud-sync.js?v=33", "./push-notifications.js?v=33", "./privacy/", "./oauth/consent/", "./oauth/consent/consent.js?v=20"];
