...
assert.match(clientFiles, /medicine === "madopark quick"/, "Madopark Quick must not affect the three-hour rule");
assert.match(readFileSync("version.js", "utf8"), /MEDICINKOLL_VERSION = "33"/);
